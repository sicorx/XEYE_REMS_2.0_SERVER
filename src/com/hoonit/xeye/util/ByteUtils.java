...
public class ByteUtils {
	...
	/**
	 * <p>입력한 value를 unsigned short 형으로 변환한다.</p>
	 * 
	 * @param src
	 * @return
	 */
	...
	/**
	 * <p>입력한 value를 unsigned int 형으로 변환한다.</p>
	 * 
	 * @param src
	 * @return
	 */
	public static long unsignedInt(long value) {
	...
	/**
	 * <p>입력한 바이트 배열(2바이트)을 short 형으로 변환한다.</p>
	 * 
	 * @param src
	 * @param srcPos
	 * @return
	...
	public static short toShort(byte[] src, int srcPos) {
		return (short)((src[srcPos] & 0xFF) | src[srcPos+1] << 8);
	}
	...
	/**
	 * <p>입력한 바이트 배열(2바이트)을 unsinged short 형으로 변환한다.</p>
	 * 
	 * @param src
	 * @return
	 */
	public static int toUnsignedShort(byte[] src) {
	...
	/**
	 * <p>입력한 바이트 배열(4바이트)을 unsinged int 형으로 변환한다.</p>
	 * 
	 * @param src
	 * @return
	 */
	public static long toUnsignedInt(byte[] src) {
		BigInteger bi = new BigInteger(src);
		return bi.intValue() & 0xFFFFFFFFL;
	}
	...
	/**
	 * <p>short 형의 값을 바이트 배열(2바이트)로 변환한다.</p>
	 * 
	 * @param value
	 * @param dest
	 * @param destPos
	 */
	public static void toBytes(short value, byte[] dest, int destPos) {
	...
	/**
	 * <p>int 형의 값을 바이트 배열(2바이트)로 변환한다.</p>
	 * 
	 * @param value
	 * @return
	 */
	public static byte[] toUnsignedShortBytes(int value) {
		byte[] dest = new byte[2];
		dest[0] = (byte) (0xFF & (value >> 8));
		dest[1] = (byte) (0xFF & value);
		return dest;
	}
	...
	/**
	 * <p>long 형의 값을 바이트 배열(4바이트)로 변환한다.</p>
	 * 
	 * @param value
	 * @return
	 */
	public static byte[] toUnsignedIntBytes(long value) {
		byte[] dest = new byte[4];
		dest[0] = (byte) (0xFF & (value >> 24));
		dest[1] = (byte) (0xFF & (value >> 16));
		dest[2] = (byte) (0xFF & (value >> 8));
		dest[3] = (byte) (0xFF & value);
		return dest;
	}
